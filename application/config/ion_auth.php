...
*/
$config['tables']['users']           = 'ar_users';
$config['tables']['groups']          = 'ar_groups';
$config['tables']['users_groups']    = 'ar_users_groups';
$config['tables']['login_attempts']  = 'ar_login_attempts';
...
$config['default_rounds'] = 5;		// This does not apply if random_rounds is set to true
 ...
 */
$config['site_title']                 = "ArtistRiot";       // Site Title, example.com
$config['admin_email']                = "nigam.satyam@gmail.com"; // Admin Email, admin@example.com
...
$config['email_activation_facebook']  = FALSE;               // Email Activation for registration
