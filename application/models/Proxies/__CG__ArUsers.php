 ...
 */
class ArUsers extends \ArUsers implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setProfileCreated($profileCreated);
    }

    public function getProfileCreated()
    {
        $this->__load();
        return parent::getProfileCreated();
    }


    public function __sleep()
    {
        return array('__isInitialized__', 'id', 'ipAddress', 'username', 'password', 'salt', 'email', 'role', 'activationCode', 'forgottenPasswordCode', 'forgottenPasswordTime', 'rememberCode', 'createdOn', 'lastLogin', 'active', 'firstName', 'lastName', 'phone', 'profileCreated');
    }
