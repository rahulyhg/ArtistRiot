 ...
 * ArUserGalleryVideos
 *
 * @ORM\Table(name="ar_user_gallery_videos")
 * @ORM\Entity
 */
class ArUserGalleryVideos
{
    /**
     * @var integer
     *
     ...
     * @var string
     *
     * @ORM\Column(name="video_url", type="string", length=400, nullable=false)
     */
    private $videoUrl;
     ...
     * @var string
     *
     * @ORM\Column(name="youtube_video_id", type="string", length=30, nullable=true)
     */
