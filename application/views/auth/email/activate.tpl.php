...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>ArtistRiot | Activate Account</title>
        <style type="text/css">
		...
		<table width="100%" cellspacing="0" cellpadding="0" style="margin-bottom: 40px;max-width:600px;border-left:solid 1px #e6e6e6;border-right:solid 1px #e6e6e6; background-color:white;">
			...
			<tr>
				<td style="padding-left:20px;width:100%;">
					Thank you for believing in us and joining us in this journey. Just one more step and your ArtistRiot profile will be ready. 
					Click on the activation link given below to complete the process:
					<br></br>
					<?php echo sprintf(lang('email_activate_subheading'), anchor('login/signup/activate/'. $id .'/'. $activation, lang('email_activate_link')));?>
				</td>
			</tr>
			<tr>
				<td style="padding-left:20px;width:100%;">
