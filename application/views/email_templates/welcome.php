		...
		<table width="100%" cellspacing="0" cellpadding="0" style="margin-bottom: 40px;max-width:600px;border-left:solid 1px #e6e6e6;border-right:solid 1px #e6e6e6; background-color:white;">
			...
			<tr>
				<td style="padding-left:20px;width:100%;">
					Thank you for showing an interest to be a part of the ArtistRiot journey. You have subscribed to our updates. We will keep you posted with the latest developments and will let you know well in advance before the launch of the website.
					<br></br>
				</td>
			</tr>
			<tr>
