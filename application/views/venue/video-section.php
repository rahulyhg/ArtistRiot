...
<div class="well" id="well">          
    ...
    <div class="row wrapper-parent" id="galleryVideoSection">
        ...
        <?php 
        if(!empty($venueGalleryVideoData) && (sizeof($venueGalleryVideoData) > 0) ){

		foreach ( $venueGalleryVideoData as $videoData ) {
		?>
        
       <div id="video_<?php echo $videoData['video_id'] ?>" class="col-sm-4 col-lg-4 col-xs-12 col-md-4 gallery-video-div linespacer">
          
          <div class="video-wrap">
    			<button type="button" class="btn btn-default btn-xs delete-venue-video" title="Delete video" >
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php
					...
					echo form_open_multipart( 'profile/managevenuedata/uploadvenuegalleryvideos', $attributes );
				?>
				<div class="col-md-12">
