    ...
    <div class="container" style="margin-top: 0px;">
        ...
        <div class="collapse navbar-collapse" id="navbar-profile">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                {
                    ?>  
                    <li ><a class="profile-links" href="<?php echo base_url() ?>profile/venue">Home</a></li>
                    <li><a class="profile-links"  href="<?php echo base_url() ?>profile/venue/photos">My Photos</a></li>
                    <li ><a class="profile-links" href="<?php echo base_url() ?>profile/venue/videos">My Videos</a></li>
