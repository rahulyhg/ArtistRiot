...
<div class="well" id="well">          
    ...
    <div class="row wrapper-parent " id="galleryImageSection" style="margin-left:0px;">
        ...
        <div id="img_<?php echo $imagedata['image_id'] ?>" class="col-sm-3 col-lg-3 col-xs-12 col-md-3 gallery-image-div linespacer">
        	...
        	<div class="img-wrap">
    			<button type="button" class="btn btn-default btn-xs delete-venue-image" title="Delete image" >
            ...
            <div class="caption" style="text-align:center;">
                	<p><?php echo $imagedata['image_description'] ?></p> 
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php
					...
					echo form_open_multipart( base_url().'profile/managevenuedata/uploadgalleryimages', $attributes );
				?>
