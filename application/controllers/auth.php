...
class Auth extends CI_Controller {
	...
	public function reset_password($code = NULL)
	{
		...
		if ($user)
		{
			...
			logDebug('new_password::'.$this->input->post('new_password'));
			logDebug('new_password_confirm::'.$this->input->post('new_password_confirm'));
	...
	function _get_csrf_nonce()
	{
		...
		logException('key::'.$key);
		logException('value::'.$value);
	...
	function _valid_csrf_nonce()
	{
		...
		{
			logDebug('Valid csrf nonce');
			return TRUE;
		}
		else
		{
			logDebug('Invalid csrf nonce');
			return FALSE;
		}
