<div class="panel panel-success">
    ...
    <div id="personalinfo" class="panel-body img-responsive" style="background : url('<?php echo base_url() ?>images/uploads/singer.jpg') 50% 50% no-repeat;background-size:cover; min-height:280px">	
